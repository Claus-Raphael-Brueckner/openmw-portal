...
namespace MWWorld
{
    ...
    public:
        ...
        inline const CellRefList<ESM::Activator>& getReadOnlyActivators() const { return get<ESM::Activator>(); }
        inline const CellRefList<ESM::Container>& getReadOnlyContainers() const { return get<ESM::Container>(); }
        inline const CellRefList<ESM::Light>& getReadOnlyLights() const { return get<ESM::Light>(); }
