...
namespace MWRender
{
        ...
        , mGroundCoverStore(groundcoverStore)
    {
        ...
        mPortalManager = std::make_unique<PortalManager>(mResourceSystem, mRootNode.get());
        mObjects->setPortalManager(mPortalManager.get());
        ...
        mPortalManager->setReflectionRTT(mWater->getReflectionRTT());
