...
namespace MWBase
{
    ...
    public:
        ...
        /// Find and force-load the CellStore for the given cell ID.
        /// Returns nullptr if the cell doesn't exist.
        virtual MWWorld::CellStore* findCellStore(const ESM::RefId& cellId) const = 0;
    };
}
